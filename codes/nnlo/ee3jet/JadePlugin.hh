...
class JadeEPlugin : public fj::JetDefinition::Plugin {
public:
  /// Main constructor for the Jade Plugin class.  
  JadeEPlugin (){}

  /// copy constructor
  JadeEPlugin (const JadeEPlugin & plugin) {
    *this = plugin;
  }
...
class JadeE0Plugin : public fj::JetDefinition::Plugin {
public:
  /// Main constructor for the Jade Plugin class.  
  JadeE0Plugin (){}

  /// copy constructor
  JadeE0Plugin (const JadeE0Plugin & plugin) {
    *this = plugin;
  }
