  subroutine user_model( model,vertx ,masses,widths,labels    &
                                     ,onlyqcd,withqcd,withhiggs )
!********************************************************************
!* The Standard Model.
!********************************************************************
  use kaleu_particles ! This is not part of Kaleu, defines "nfirst,nlast"
                ! and the particle names "gluon,uquark,etc..."
  use avh_kaleu_model
  implicit none
