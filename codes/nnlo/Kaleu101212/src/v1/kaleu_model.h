...
!
  subroutine model_wght_above( model,ii ,ww ,ss,slow,supp )
!********************************************************************
!* return jacobian ww
!********************************************************************
  implicit none
...
!********************************************************************
!* generate p(s) = 1/| s + frac*(supp+slow) | for  slow < s < supp
!********************************************************************
  implicit none
  type(model_type) ,intent(in)    :: model
  integer          ,intent(in)    :: ii
...
!
  subroutine model_wght_below( model,ii ,ww ,ss,slow,supp )
!********************************************************************
!********************************************************************
  implicit none
  type(model_type) ,intent(in)  :: model
